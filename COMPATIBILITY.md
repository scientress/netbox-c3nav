...
This document tracks the minimum and maximum supported NetBox versions for each release of NetBox c3nav floor plans.
...
- This plugin requires Python 3.13 or later
